...
from dataval.dataloader import DataFetcher, mix_labels
from dataval.datavaluation import DataEvaluator
from dataval.experiment.util import filter_kwargs
from dataval.metrics import Metrics
from dataval.model import Model, ModelFactory
...
class ExperimentMediator:
    ...
    def model_factory_setup(
        ...
        valid_count: Union[int, float] = 0,
        test_count: Union[int, float] = 0,
        meta_count: Union[int, float] = 0,  # Number of meta data points
        add_noise: Union[Callable[[DataFetcher], dict[str, Any]], str] = mix_labels,
        noise_kwargs: Optional[dict[str, Any]] = None,
        random_state: Optional[RandomState] = None,
        ...
        py:function`~dataval.model.ModelFactory`
    ...
    def evaluate(
        ...
        **exper_kwargs,
        ...
        for data_val in self.data_evaluators:
            if exper_func.__name__ == "noisy_detection":
                eval_resp = exper_func(data_val, self.fetcher, filter, **filtered_kwargs)
            else:
    ...
    def compute_data_state(
        ...
        **exper_kwargs,
        ...
        for data_val in self.data_evaluators:
            time_span, traj = exper_func(data_val, self.fetcher, **filtered_kwargs)
    ...
    def compute_x_y_state(
        ...
        **exper_kwargs,
        ...
        for data_val in self.data_evaluators:
            x_state, y_state = exper_func(data_val, self.fetcher, **filtered_kwargs)
    ...
    def compute_data_loss(
        ...
        **exper_kwargs,
        ...
        for data_val in self.data_evaluators:
            data_loss = exper_func(data_val, self.fetcher, **filtered_kwargs)
        return data_loss
    ...
    def compute_train_loss(
        ...
        **exper_kwargs,
        ...
        for data_val in self.data_evaluators:
            train_loss, meta_loss = exper_func(data_val, self.fetcher, **filtered_kwargs)
            data_eval_perf["train_loss"] = train_loss
            data_eval_perf["meta_loss"] = meta_loss
    ...
    def plot(
        ...
        **exper_kwargs,
        ...
        for i, data_val in enumerate(self.data_evaluators, start=1):
            ...
            eval_resp = exper_func(data_val, self.fetcher, percentile=percnet, **filtered_kwargs)
