...
from dataval.dataloader.register import Register, _from_pandas, cache

CHALLENGE_URL = "https://opendataval.yongchanstat.com/challenge"
"""Backend URL for dataval to get drive ids to the challenge data set."""
...
def _challenge_ids(challenge: str) -> list[dict[str, str]]:
    """Get challenge ids from the dataval backend."""
