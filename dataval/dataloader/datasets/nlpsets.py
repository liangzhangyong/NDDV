...
from dataval.dataloader.util import FolderDataset, ListDataset
...
def BertEmbeddings(
    ...
    def wrapper(
        ...
        tokenizer = DistilBertTokenizerFast.from_pretrained(BERT_PRETRAINED_NAME, local_files_only=True)
        bert_model = DistilBertModel.from_pretrained(BERT_PRETRAINED_NAME, local_files_only=True).to(device)
